                    ...
                    ->schema([
                        ...
                        Infolists\Components\RepeatableEntry::make('properties.detailed_batches')
                            ...
                            ->schema([
                                ...
                                Infolists\Components\TextEntry::make('import_price')->label('Giá nhập lô')->formatStateUsing(fn($state) => number_format((float)($state ?? 0), 0, ',', '.') . ' ₫'),
                            ])
                            ->columns(5)
                            ->columnSpanFull()
                        ...
                        Infolists\Components\RepeatableEntry::make('properties.detailed_items')
                            ...
                            ->schema([
                                ...
                                Infolists\Components\TextEntry::make('import_price')->label('Giá nhập đơn vị')->formatStateUsing(fn($state) => number_format((float)($state ?? 0), 0, ',', '.') . ' ₫'),
