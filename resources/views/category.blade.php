...
@section('content')
    <div class="container mx-auto px-4 lg:px-8 py-6">
        ...
        <div class="flex items-center justify-between mb-6">
            <h1 class="text-2xl font-bold text-gray-800 uppercase">{{ $category->name }}</h1>
            <span class="text-gray-500">{{ $products->total() }} sản phẩm</span>
        </div>

        <!-- Filter Bar -->
        <div
            class="bg-white p-4 rounded-lg shadow-sm border border-gray-100 mb-6 flex flex-wrap gap-4 items-center justify-between">
