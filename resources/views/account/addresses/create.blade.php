...
<div class="bg-white rounded-lg shadow-sm p-6">
    ...
    <form method="POST" action="{{ route('account.addresses.store') }}" class="max-w-xl">
        @csrf
        ...
        <div class="space-y-5">
            ...
            <div>
                ...
                <textarea name="address" id="address" rows="3" required
                          class="block w-full rounded-md border-gray-300 shadow-sm focus:border-brand-blue focus:ring-brand-blue text-sm">{{ old('address') }}</textarea>
